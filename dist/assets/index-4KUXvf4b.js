(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function s(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(o){if(o.ep)return;o.ep=!0;const a=s(o);fetch(o.href,a)}})();const S=[{id:"beginning",chapter:"01",title:"Where It All Began",detail:"Curiosity was where it all started",description:"I started my journey without knowing exactly where it would lead. Through university projects, new experiences, and plenty of learning along the way, I gradually discovered my interest in creating digital experiences that bring creativity and technology together. Looking back at where I started reminds me how much I’ve grown — and how much more there is to explore.",image:"",art:"beginning",gallery:[{label:"Then",caption:"Where it started",image:"./assets/flower1-then.jpg"},{label:"Now",caption:"Still learning, still growing.",image:"./assets/flower1-now.jpg"}],tree:{x:50,y:29},position:{x:50,y:12}},{id:"proud-moment",chapter:"02",title:"A Proud Moment",detail:"Performance · Dean’s List · A full-circle journey",description:"Since Semester 1, I have taken part as both a dancer and singer in MAJIS and ISSNITE. MAJIS is a celebratory gathering that recognises Dean’s List students, while ISSNITE is our faculty’s farewell celebration for final-semester students. I began by contributing as a performer, then attended my final MAJIS in Semester 5 to celebrate my Semester 4 Dean’s List achievement. Later, I returned to ISSNITE in a senior role—a full-circle moment that showed how much I had grown in confidence, experience and responsibility.",image:"",art:"internship",gallery:[{label:"The Beginning",caption:"Taking part as a dancer and singer",image:"./assets/flower2-performer.jpg"},{label:"A Milestone",caption:"My final MAJIS",image:"./assets/flower2-deans-list.jpg"},{label:"Full Circle",caption:"Returning to ISSNITE in a senior role",image:"./assets/flower2-senior.jpg"}],tree:{x:65,y:43},position:{x:88,y:48}},{id:"beyond-classroom",chapter:"03",title:"Beyond the Classroom",detail:"Some of the best lessons happened outside of it.",description:"Taking part in activities beyond academics gave me opportunities to connect with different people, work as part of a team, and step outside my comfort zone. Each experience taught me something new and became a meaningful part of my growth throughout my student journey.",image:"",art:"hitern",gallery:[{label:"Teamwork",caption:"Learning and contributing together",image:"./assets/flower3-classroom-2.jpg"},{label:"Communication",caption:"Connecting through shared activities",image:"./assets/flower3-classroom-3.jpg"},{label:"New Experiences",caption:"Stepping outside my comfort zone",image:"./assets/flower3-classroom-4.jpg"},{label:"Growth",caption:"Building confidence with others",image:"./assets/flower3-classroom-5.jpg"},{label:"Teamwork",caption:"Growing through every experience",image:"./assets/flower3-classroom-7.jpg"},{label:"New Experiences",caption:"Making memories beyond the classroom",image:"./assets/flower3-classroom-8.jpg"}],tree:{x:51,y:58},position:{x:50,y:86}},{id:"what-drives-me",chapter:"04",title:"What Drives Me",detail:"Still learning. Still creating. Still growing.",description:"I’m drawn to the process of turning an idea into something people can actually see, use and enjoy. I love learning through experimentation, improving through feedback, and watching an idea gradually become a real experience.",image:"",art:"achievement",gallery:[{label:"What Drives Me",caption:"Turning ideas into experiences",image:"./assets/flower4.png"},{label:"Design in Progress",caption:"Bringing an idea to life in Figma",image:"./assets/flower4-design-process.jpeg"}],tree:{x:35,y:43},position:{x:12,y:50}}],fe="/",p=e=>`${fe}assets/${e}`;let ve=0;const x=(e="")=>{const t=`sakura-${ve++}`;return`
  ...
  <div class="sakura-cursor" aria-hidden="true">${be()}</div>
      ...
      <div class="tools-showcase" aria-label="Tools and applications I use">
        ...
        <div class="tools-marquee">
          <div class="tools-track">
            ${[...D,...D].map((e,t)=>`
              <div class="tool-item" ${t>=D.length?'aria-hidden="true"':""}>
                <span class="tool-mark"><img src="${p(`tool-icons/${Se[e]}`)}" alt="" loading="lazy"></span>
                <strong>${e}</strong>
              </div>`).join("")}
          </div>
        </div>
...
`;const F=[...document.querySelectorAll(".greeting-word")],ke=document.querySelector(".begin-cue");let T=0;window.setInterval(()=>{F[T].classList.remove("is-visible"),T=(T+1)%F.length,F[T].classList.add("is-visible")},1450);const Y=document.querySelector(".sakura-cursor"),xe=matchMedia("(hover:hover) and (pointer:fine) and (min-width:1025px) and (prefers-reduced-motion:no-preference)").matches;let B=0,R={x:-80,y:-80},J=0;const G=new Set;xe&&window.addEventListener("pointermove",e=>{if(R={x:e.clientX,y:e.clientY},B||(B=requestAnimationFrame(()=>{Y.style.transform=`translate3d(${R.x}px,${R.y}px,0)`,Y.classList.add("is-visible"),B=0})),performance.now()-J<110||G.size>=12)return;J=performance.now();const t=document.createElement("i");t.className="trail-petal",t.style.cssText=`left:${e.clientX}px;top:${e.clientY}px;--drift:${(Math.random()-.5)*60}px;--spin:${(Math.random()-.5)*240}deg`,G.add(t),document.body.append(t),t.addEventListener("animationend",()=>{G.delete(t),t.remove()},{once:!0})},{passive:!0});const b=document.querySelector(".hero-scene");document.querySelector(".primary-button");const u=document.querySelector(".scroll-butterfly-guide"),Le=u.querySelector(".guide-tip");new IntersectionObserver(([e])=>{e.isIntersecting&&!b.classList.contains("has-grown")&&b.classList.add("has-grown")},{threshold:.28}).observe(b);const L=document.querySelector(".hero-nature"),H=new Set;let _=0;matchMedia("(hover:hover) and (pointer:fine) and (prefers-reduced-motion:no-preference)").matches&&(b.addEventListener("pointermove",e=>{const t=b.getBoundingClientRect(),s={x:t.left+t.width*.77,y:t.top+t.height*.34},i=e.clientX-s.x,o=e.clientY-s.y,a=Math.hypot(i,o);if(a>180){L.style.setProperty("--react-x","0deg"),L.style.setProperty("--react-y","0px");return}const r=1-a/180;if(L.style.setProperty("--react-x",`${Math.max(-3,Math.min(3,-i/55*r))}deg`),L.style.setProperty("--react-y",`${-o/20*r}px`),performance.now()-_>850&&H.size<3&&Math.random()>.55){_=performance.now();const n=document.createElement("i");n.className="released-petal",n.style.cssText=`left:${68+Math.random()*22}%;top:${24+Math.random()*28}%;--petal-drift:${(Math.random()-.5)*140}px;--petal-spin:${160+Math.random()*260}deg`,H.add(n),b.append(n),n.addEventListener("animationend",()=>{H.delete(n),n.remove()},{once:!0})}},{passive:!0}),b.addEventListener("pointerleave",()=>{L.style.setProperty("--react-x","0deg"),L.style.setProperty("--react-y","0px")}));const j=document.querySelector(".door-scene"),U=document.querySelector(".journey-section"),$e=document.querySelector(".timeline-rail"),je=document.querySelector('.site-nav a[data-section="door-scene"]'),oe=.68,Q=matchMedia("(prefers-reduced-motion:reduce)").matches;let A=!1,z=0,K=scrollY;function re(){const e=Math.max(0,j.offsetHeight-innerHeight);return j.offsetTop+e*oe}je.addEventListener("click",e=>{e.preventDefault();const t=re();A=!0,history.replaceState(null,"","#door-scene"),window.scrollTo({top:t,behavior:Q?"auto":"smooth"})});let N=0,Z=!1,ne=!1;function Me(){if(Z||Q)return;const e=[...document.querySelectorAll(".memory-flower")].map(r=>{const n=r.getBoundingClientRect();return{x:n.left+n.width/2,y:n.top+n.height/2}});if(e.length!==S.length)return;Z=!0;const t={x:innerWidth*.78,y:innerHeight*.62},s=[{x:-60,y:Math.max(innerHeight*.55,e[0].y+70)},...e,t],i=[0,.12,.32,.5,.68,.86],o=s.map((r,n)=>({offset:i[n],transform:`translate3d(${r.x}px,${r.y}px,0) translate(-50%,-50%) scale(${n?1:.72})`,opacity:n?1:0,easing:"cubic-bezier(.35,.05,.25,1)"})),a=u.animate(o,{duration:7200,fill:"forwards"});a.finished.then(()=>{ne=!0,u.style.setProperty("--guide-screen-x","78vw"),u.style.setProperty("--guide-screen-y","62vh"),u.classList.add("has-tip"),a.cancel()}).catch(()=>{})}function le(){const e=j.getBoundingClientRect(),t=j.offsetHeight-innerHeight,s=Math.max(1,t*oe),i=Math.max(0,Math.min(1,-e.top/s)),o=scrollY>K;!Q&&!A&&o&&z<.94&&i>=.94&&(A=!0,window.scrollTo({top:re(),behavior:"smooth"})),i<.65&&(A=!1),z=i,K=scrollY,j.style.setProperty("--door-progress",i.toFixed(3));const a=U.getBoundingClientRect(),r=$e.getBoundingClientRect(),n=Math.max(105,Math.min(innerHeight*.56,r.bottom-18)),g=Math.max(0,Math.min(1,(n-r.top)/Math.max(1,r.height)));U.style.setProperty("--journey-progress",g.toFixed(3));const m=i>.94&&a.top>innerHeight*.55,f=r.top<=innerHeight*.56&&r.bottom>=105,v=m||f;let k,E;m?(k=innerWidth*.78,E=innerHeight*.54):f?(k=r.left+r.width/2,E=n):(k=innerWidth*.5,E=innerHeight*.6),u.style.setProperty("--guide-screen-x",`${k}px`),u.style.setProperty("--guide-screen-y",`${E}px`),u.classList.toggle("is-following",v),u.classList.toggle("has-tip",m&&ne),u.classList.toggle("is-tree-orbiting",m),u.classList.toggle("is-on-timeline",f),u.setAttribute("aria-hidden",String(!v)),Le.textContent="Click a flower to discover more about Queenie.",m&&Me(),b.classList.toggle("guide-is-travelling",v),document.querySelector(".home-nav").classList.toggle("has-background",scrollY>8),N=0}window.addEventListener("scroll",()=>{N||(N=requestAnimationFrame(le))},{passive:!0});le();const M=[...document.querySelectorAll(".site-nav a")];M.map(e=>document.getElementById(e.dataset.section)).filter(Boolean);new IntersectionObserver(e=>{const t=e.filter(s=>s.isIntersecting).sort((s,i)=>i.intersectionRatio-s.intersectionRatio)[0];t&&M.forEach(s=>s.classList.toggle("is-active",s.dataset.section===t.target.id))},{rootMargin:"-34% 0px -52%",threshold:[0,.2,.5]}).observe(j);new IntersectionObserver(e=>{e[0].isIntersecting&&M.forEach(t=>t.classList.toggle("is-active",t.dataset.section==="journey"))},{rootMargin:"-32% 0px -55%",threshold:0}).observe(U);const Ie=document.querySelector(".work-section");new IntersectionObserver(e=>{e[0].isIntersecting&&M.forEach(t=>t.classList.toggle("is-active",t.dataset.section==="work"))},{rootMargin:"-32% 0px -55%",threshold:0}).observe(Ie);const O=document.querySelector(".skills-section");new IntersectionObserver(e=>{e[0].isIntersecting&&M.forEach(t=>t.classList.toggle("is-active",t.dataset.section==="skills"))},{rootMargin:"-32% 0px -55%",threshold:0}).observe(O);const qe=document.querySelector(".contact-section");new IntersectionObserver(e=>{e[0].isIntersecting&&M.forEach(t=>t.classList.toggle("is-active",t.dataset.section==="contact"))},{rootMargin:"-32% 0px -55%",threshold:0}).observe(qe);const Ee=document.querySelectorAll(".journey-milestone"),Te=new IntersectionObserver(e=>{e.forEach(t=>{t.isIntersecting&&t.target.classList.add("is-visible")})},{threshold:.2});Ee.forEach(e=>Te.observe(e));const I=document.querySelectorAll(".work-card"),Ce=new IntersectionObserver(e=>{e.forEach(t=>{t.isIntersecting&&t.target.classList.add("is-visible")})},{threshold:.15});I.forEach(e=>Ce.observe(e));const q=[...document.querySelectorAll(".work-filter")],ee=document.querySelector(".work-filter-indicator"),Ae=document.querySelector(".work-empty");let te=0;function X(e){ee.style.setProperty("--filter-left",`${e.offsetLeft}px`),ee.style.setProperty("--filter-width",`${e.offsetWidth}px`)}async function Pe(e){const t=++te,s=[...I].filter(a=>e==="all"||a.dataset.category===e),i=q.find(a=>a.dataset.filter===e);q.forEach(a=>{const r=a===i;a.classList.toggle("is-active",r),a.setAttribute("aria-pressed",String(r))}),X(i);const o=[...I].filter(a=>!a.hidden);await Promise.all(o.map(a=>a.animate([{opacity:1,transform:"translateY(0)"},{opacity:0,transform:"translateY(12px)"}],{duration:180,easing:"ease-out",fill:"forwards"}).finished.catch(()=>{}))),t===te&&(I.forEach(a=>{const r=s.includes(a);a.hidden=!r,a.classList.remove("is-filter-featured","is-filter-even")}),e!=="all"&&(s[0]?.classList.add("is-filter-featured"),s.slice(1).forEach((a,r)=>a.classList.toggle("is-filter-even",r%2===0))),Ae.hidden=s.length>0,s.forEach(a=>a.animate([{opacity:0,transform:"translateY(18px)"},{opacity:1,transform:"translateY(0)"}],{duration:380,delay:60,easing:"cubic-bezier(.2,.75,.2,1)",fill:"both"})))}q.forEach(e=>e.addEventListener("click",()=>Pe(e.dataset.filter)));requestAnimationFrame(()=>X(q.find(e=>e.classList.contains("is-active"))));window.addEventListener("resize",()=>X(q.find(e=>e.classList.contains("is-active"))));const se=new WeakSet;function ce(e){if(!e||se.has(e))return;const t=[...e.querySelectorAll("img")];if(t.length<2)return;const s=e.closest(".project-preview, .case-study-visual")??e;let i=0,o=null;const a=g=>{const h=t[i];h.classList.add("is-leaving"),h.classList.remove("is-active"),window.setTimeout(()=>h.classList.remove("is-leaving"),600),i=g%t.length,t[i].classList.add("is-active")},r=()=>{o||(e.classList.add("is-playing"),o=window.setInterval(()=>a(i+1),1350))},n=()=>{window.clearInterval(o),o=null,e.classList.remove("is-playing"),a(0)};s.addEventListener("pointerenter",r),s.addEventListener("pointerleave",n),se.add(e)}document.querySelectorAll(".project-screenshot-carousel").forEach(ce);new IntersectionObserver(([e],t)=>{e.isIntersecting&&(O.classList.add("is-visible"),t.disconnect())},{threshold:.18}).observe(O);const C=document.querySelector(".letter-button"),De=document.querySelector(".letter-note");C.addEventListener("click",()=>{const e=C.getAttribute("aria-expanded")==="true";C.setAttribute("aria-expanded",String(!e)),De.hidden=e,C.querySelector("i").textContent=e?"＋":"−"});document.querySelector(".contact-form").addEventListener("submit",e=>{e.preventDefault();const t=new FormData(e.currentTarget),s=t.get("name").trim(),i=t.get("email").trim(),o=t.get("message").trim(),a=encodeURIComponent(`Portfolio enquiry from ${s}`),r=encodeURIComponent(`${o}

From: ${s}
Email: ${i}`);window.location.href=`mailto:qthamshinee@gmail.com?subject=${a}&body=${r}`});const l=document.querySelector(".project-modal"),de=l.querySelector(".project-modal-close");let pe=null;function Fe(e,t){const s=ie[e];pe=t,l.className=`project-modal project-modal--${s.slug}`,l.querySelector(".case-number").textContent=s.number,l.querySelector("#project-modal-title").textContent=s.title,l.querySelector(".case-role").textContent=s.role,l.querySelector(".case-summary").textContent=s.summary,l.querySelector(".case-challenge").textContent=s.challenge,l.querySelector(".case-approach").textContent=s.approach,l.querySelector(".case-outcome").textContent=s.outcome;const i=l.querySelector(".case-highlights");i.hidden=!s.highlights,i.innerHTML=s.highlights?.map(([m,f])=>`<span><strong>${m}</strong>${f}</span>`).join("")??"",l.querySelector(".case-tools").innerHTML=s.tools.map(m=>`<li>${m}</li>`).join("");const o=l.querySelector(".case-study-visual"),a=o.querySelector(".case-screenshot-carousel"),r=Array.isArray(s.images)&&s.images.length>0;a.hidden=!r,r&&a.dataset.project!==s.slug&&(a.dataset.project=s.slug,a.innerHTML=s.images.map((m,f)=>`<img class="${f===0?"is-active":""}" src="${p(m)}" alt="">`).join("")),o.classList.toggle("has-project-image",!!s.image||r),o.style.backgroundImage=s.image?`url("${p(s.image)}")`:"",r&&ce(a);const n=l.querySelector(".case-live-link");n.href=s.link,n.textContent=s.slug==="language"||s.slug==="apcs"?"Watch project walkthrough":"View live project";const g=l.querySelector(".case-prototype-link");g.hidden=!s.prototype,s.prototype&&(g.href=s.prototype);const h=l.querySelector(".case-manual-link");h.hidden=!s.manual,s.manual&&(h.href=p(s.manual)),l.hidden=!1,document.body.classList.add("modal-open"),requestAnimationFrame(()=>l.classList.add("is-open")),de.focus()}function me(){l.classList.remove("is-open"),document.body.classList.remove("modal-open"),setTimeout(()=>{l.hidden=!0,pe?.focus()},450)}I.forEach((e,t)=>{e.querySelectorAll(".project-preview,.case-study-link").forEach(s=>s.addEventListener("click",()=>Fe(t,s)))});de.addEventListener("click",me);const V=[...document.querySelectorAll(".memory-flower")],Be=document.querySelector(".discovery-progress span"),c=document.querySelector(".memory-modal"),W=document.querySelector(".memory-garden"),Re=document.querySelector(".tree-instruction"),$=document.querySelector(".tree-guide-butterfly"),Ge=document.querySelector(".discovery-progress"),d={viewMode:"tree",currentMemory:null,activeFlowerIndex:0,discoveredMemories:new Set};let ue=null,ge=!1;const y=c.querySelector(".memory-photo-marquee");let w=null;y.addEventListener("pointerdown",e=>{y.classList.contains("is-single-photo")||(w={pointerId:e.pointerId,startX:e.clientX,startScroll:y.scrollLeft},y.classList.add("is-dragging"),y.setPointerCapture(e.pointerId))});y.addEventListener("pointermove",e=>{!w||w.pointerId!==e.pointerId||(y.scrollLeft=w.startScroll-(e.clientX-w.startX))});const he=e=>{!w||w.pointerId!==e.pointerId||(w=null,y.classList.remove("is-dragging"))};y.addEventListener("pointerup",he);y.addEventListener("pointercancel",he);function P(){const e=d.discoveredMemories.size===S.length;if(V.forEach((t,s)=>{const i=d.discoveredMemories.has(s),o=!e&&s===d.activeFlowerIndex&&!i;t.className=`memory-flower ${i?"is-bloomed":o?"is-active":"is-closed"}`,t.setAttribute("aria-current",o?"step":"false"),t.setAttribute("aria-label",`${i?"Revisit":"Discover"} ${S[s].title} memory`)}),Be.textContent=String(Math.min(d.discoveredMemories.size+(e?0:1),4)).padStart(2,"0"),Ge.classList.toggle("is-complete",e),Re.textContent=e?"Four moments, one growing journey.":"Select the glowing flower to discover a memory.",$.classList.toggle("is-settled",e),!e&&ge){const t=S[d.activeFlowerIndex].tree;$.style.setProperty("--guide-x",`${t.x}%`),$.style.setProperty("--guide-y",`${t.y}%`),$.classList.remove("is-guiding"),requestAnimationFrame(()=>$.classList.add("is-guiding"))}}new IntersectionObserver(([e],t)=>{e.isIntersecting&&(ge=!0,document.querySelector(".door-sticky").classList.add("tree-is-revealing"),P(),t.disconnect())},{threshold:.55}).observe(document.querySelector(".door-sticky"));function ae(e,t,s=!1){const i=S[e];ue=t,c.dataset.memory=i.id,d.currentMemory=e,d.viewMode="memory",s&&d.discoveredMemories.add(e),P(),c.querySelector("#modal-title").textContent=i.title,c.querySelector(".modal-copy .scene-label").textContent=`${i.chapter} · A personal chapter`,c.querySelector(".modal-description").textContent=i.description,c.querySelector(".modal-detail").textContent=i.detail;const o=c.querySelector(".modal-image");o.className=`modal-image memory-image-${i.art}`,o.style.backgroundImage=i.image?`url("${i.image}")`:"",o.setAttribute("aria-label",`${i.title} placeholder image`);const a=c.querySelector(".memory-photo-marquee"),r=c.querySelector(".detail-blossom"),n=Array.isArray(i.gallery)?i.gallery.filter(h=>h.image):[],g=n.length>0;if(a.hidden=!g,a.classList.remove("is-single-photo"),r.hidden=g,c.querySelector(".memory-detail").classList.toggle("has-photo-gallery",g),g){const h=3.4285714285714284,m=20/7;a.style.setProperty("--memory-scroll-duration",`${n.length*h}s`),a.style.setProperty("--memory-scroll-duration-mobile",`${n.length*m}s`);const f=[...n,...n];a.querySelector(".memory-photo-track").innerHTML=f.map((v,k)=>`
      <figure class="memory-photo-card" ${k>=n.length?'aria-hidden="true"':""}>
        <img src="${v.image}" alt="${v.label} — ${v.caption}">
        <figcaption><strong>${v.label}</strong><span>${v.caption}</span></figcaption>
      </figure>`).join(""),a.scrollLeft=0}c.hidden=!1,document.body.classList.add("modal-open"),W.classList.add("is-softened"),requestAnimationFrame(()=>c.classList.add("is-open")),c.querySelector("#modal-title").focus()}V.forEach((e,t)=>{e.addEventListener("click",()=>{if(d.discoveredMemories.has(t)){ae(t,e);return}t===d.activeFlowerIndex&&($.classList.remove("is-guiding"),ae(t,e,!0))})});function ye(){c.classList.remove("is-open"),W.classList.remove("is-softened"),W.classList.remove("is-transitioning"),document.body.classList.remove("modal-open"),d.viewMode="tree";const e=S.findIndex((t,s)=>!d.discoveredMemories.has(s));d.activeFlowerIndex=e===-1?0:e,P(),setTimeout(()=>{c.hidden=!0,V[d.currentMemory]?.classList.remove("is-entering"),ue?.focus(),d.currentMemory=null},500)}c.addEventListener("click",ye);window.addEventListener("keydown",e=>{e.key==="Escape"&&!c.hidden&&ye(),e.key==="Escape"&&!l.hidden&&me()});matchMedia("(prefers-reduced-motion:reduce)").matches&&ke.classList.add("is-visible");P();
