(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function s(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(o){if(o.ep)return;o.ep=!0;const a=s(o);fetch(o.href,a)}})();const k=[{id:"beginning",chapter:"01",title:"Where It All Began",detail:"Curiosity was where it all started",description:"I started my journey without knowing exactly where it would lead. Through university projects, new experiences, and plenty of learning along the way, I gradually discovered my interest in creating digital experiences that bring creativity and technology together. Looking back at where I started reminds me how much I’ve grown — and how much more there is to explore.",image:"",art:"beginning",gallery:[{label:"Then",caption:"Where it started",image:"./assets/flower1-then.jpg"},{label:"Now",caption:"Still learning, still growing.",image:"./assets/flower1-now.jpg"}],tree:{x:50,y:29},position:{x:50,y:12}},{id:"proud-moment",chapter:"02",title:"A Proud Moment",detail:"Performance · Dean’s List · A full-circle journey",description:"Since Semester 1, I have taken part as both a dancer and singer in MAJIS and ISSNITE. MAJIS is a celebratory gathering that recognises Dean’s List students, while ISSNITE is our faculty’s farewell celebration for final-semester students. I began by contributing as a performer, then attended my final MAJIS in Semester 5 to celebrate my Semester 4 Dean’s List achievement. Later, I returned to ISSNITE in a senior role—a full-circle moment that showed how much I had grown in confidence, experience and responsibility.",image:"",art:"internship",gallery:[{label:"The Beginning",caption:"Taking part as a dancer and singer",image:"./assets/flower2-performer.jpg"},{label:"A Milestone",caption:"My final MAJIS",image:"./assets/flower2-deans-list.jpg"},{label:"Full Circle",caption:"Returning to ISSNITE in a senior role",image:"./assets/flower2-senior.jpg"}],tree:{x:65,y:43},position:{x:88,y:48}},{id:"beyond-classroom",chapter:"03",title:"Beyond the Classroom",detail:"Some of the best lessons happened outside of it.",description:"Taking part in activities beyond academics gave me opportunities to connect with different people, work as part of a team, and step outside my comfort zone. Each experience taught me something new and became a meaningful part of my growth throughout my student journey.",image:"",art:"hitern",gallery:[{label:"Teamwork",caption:"Learning and contributing together",image:"./assets/flower3-classroom-2.jpg"},{label:"Communication",caption:"Connecting through shared activities",image:"./assets/flower3-classroom-3.jpg"},{label:"New Experiences",caption:"Stepping outside my comfort zone",image:"./assets/flower3-classroom-4.jpg"},{label:"Growth",caption:"Building confidence with others",image:"./assets/flower3-classroom-5.jpg"},{label:"Teamwork",caption:"Growing through every experience",image:"./assets/flower3-classroom-7.jpg"},{label:"New Experiences",caption:"Making memories beyond the classroom",image:"./assets/flower3-classroom-8.jpg"}],tree:{x:51,y:58},position:{x:50,y:86}},{id:"what-drives-me",chapter:"04",title:"What Drives Me",detail:"Still learning. Still creating. Still growing.",description:"I’m drawn to the process of turning an idea into something people can actually see, use and enjoy. I love learning through experimentation, improving through feedback, and watching an idea gradually become a real experience.",image:"",art:"achievement",gallery:[{label:"What Drives Me",caption:"Turning ideas into experiences",image:"./assets/flower4.png"},{label:"Design in Progress",caption:"Bringing an idea to life in Figma",image:"./assets/flower4-design-process.jpeg"}],tree:{x:35,y:43},position:{x:12,y:50}}],Le="/",d=e=>`${Le}assets/${e}`;let xe=0;const S=(e="")=>{const t=`sakura-${xe++}`;return`
  ...
  <div class="sakura-cursor" aria-hidden="true">${$e()}</div>
          ...
          <article class="work-card work-card--${e.slug} ${t===0?"work-card--featured":""}" data-project="${t}" data-category="${e.category}">
            <button class="project-preview" type="button" aria-label="View ${e.title} case study">
              ...
              ${e.images?`<span class="screenshot-carousel project-screenshot-carousel" aria-hidden="true">
                ${e.images.map((s,i)=>`<img class="${i===0?"is-active":""}" src="${d(s)}" alt="">`).join("")}
              </span>`:""}
          ...
          <div class="tools-track">
            ${[...N,...N].map((e,t)=>`
              <div class="tool-item" ${t>=N.length?'aria-hidden="true"':""}>
                <span class="tool-mark"><img src="${d(`tool-icons/${Ee[e]}`)}" alt="" loading="lazy"></span>
                <strong>${e}</strong>
              </div>`).join("")}
          </div>
        </div>
...
`;const O=[...document.querySelectorAll(".greeting-word")],Me=document.querySelector(".begin-cue");let P=0;window.setInterval(()=>{O[P].classList.remove("is-visible"),P=(P+1)%O.length,O[P].classList.add("is-visible")},1450);const _=document.querySelector(".sakura-cursor"),Ie=matchMedia("(hover:hover) and (pointer:fine) and (min-width:1025px) and (prefers-reduced-motion:no-preference)").matches;let B=0,G={x:-80,y:-80},Z=0;const H=new Set;Ie&&window.addEventListener("pointermove",e=>{if(G={x:e.clientX,y:e.clientY},B||(B=requestAnimationFrame(()=>{_.style.transform=`translate3d(${G.x}px,${G.y}px,0)`,_.classList.add("is-visible"),B=0})),performance.now()-Z<110||H.size>=12)return;Z=performance.now();const t=document.createElement("i");t.className="trail-petal",t.style.cssText=`left:${e.clientX}px;top:${e.clientY}px;--drift:${(Math.random()-.5)*60}px;--spin:${(Math.random()-.5)*240}deg`,H.add(t),document.body.append(t),t.addEventListener("animationend",()=>{H.delete(t),t.remove()},{once:!0})},{passive:!0});const b=document.querySelector(".hero-scene");document.querySelector(".primary-button");const u=document.querySelector(".scroll-butterfly-guide"),qe=u.querySelector(".guide-tip");new IntersectionObserver(([e])=>{e.isIntersecting&&!b.classList.contains("has-grown")&&b.classList.add("has-grown")},{threshold:.28}).observe(b);const $=document.querySelector(".hero-nature"),U=new Set;let ee=0;matchMedia("(hover:hover) and (pointer:fine) and (prefers-reduced-motion:no-preference)").matches&&(b.addEventListener("pointermove",e=>{const t=b.getBoundingClientRect(),s={x:t.left+t.width*.77,y:t.top+t.height*.34},i=e.clientX-s.x,o=e.clientY-s.y,a=Math.hypot(i,o);if(a>180){$.style.setProperty("--react-x","0deg"),$.style.setProperty("--react-y","0px");return}const r=1-a/180;if($.style.setProperty("--react-x",`${Math.max(-3,Math.min(3,-i/55*r))}deg`),$.style.setProperty("--react-y",`${-o/20*r}px`),performance.now()-ee>850&&U.size<3&&Math.random()>.55){ee=performance.now();const n=document.createElement("i");n.className="released-petal",n.style.cssText=`left:${68+Math.random()*22}%;top:${24+Math.random()*28}%;--petal-drift:${(Math.random()-.5)*140}px;--petal-spin:${160+Math.random()*260}deg`,U.add(n),b.append(n),n.addEventListener("animationend",()=>{U.delete(n),n.remove()},{once:!0})}},{passive:!0}),b.addEventListener("pointerleave",()=>{$.style.setProperty("--react-x","0deg"),$.style.setProperty("--react-y","0px")}));const M=document.querySelector(".door-scene"),V=document.querySelector(".journey-section"),Te=document.querySelector(".timeline-rail"),Ae=document.querySelector('.site-nav a[data-section="door-scene"]'),le=.68,Y=matchMedia("(prefers-reduced-motion:reduce)").matches;let R=!1,te=0,se=scrollY;function ce(){const e=Math.max(0,M.offsetHeight-innerHeight);return M.offsetTop+e*le}Ae.addEventListener("click",e=>{e.preventDefault();const t=ce();R=!0,history.replaceState(null,"","#door-scene"),window.scrollTo({top:t,behavior:Y?"auto":"smooth"})});let W=0,ae=!1,de=!1;function Ce(){if(ae||Y)return;const e=[...document.querySelectorAll(".memory-flower")].map(r=>{const n=r.getBoundingClientRect();return{x:n.left+n.width/2,y:n.top+n.height/2}});if(e.length!==k.length)return;ae=!0;const t={x:innerWidth*.78,y:innerHeight*.62},s=[{x:-60,y:Math.max(innerHeight*.55,e[0].y+70)},...e,t],i=[0,.12,.32,.5,.68,.86],o=s.map((r,n)=>({offset:i[n],transform:`translate3d(${r.x}px,${r.y}px,0) translate(-50%,-50%) scale(${n?1:.72})`,opacity:n?1:0,easing:"cubic-bezier(.35,.05,.25,1)"})),a=u.animate(o,{duration:7200,fill:"forwards"});a.finished.then(()=>{de=!0,u.style.setProperty("--guide-screen-x","78vw"),u.style.setProperty("--guide-screen-y","62vh"),u.classList.add("has-tip"),a.cancel()}).catch(()=>{})}function pe(){const e=M.getBoundingClientRect(),t=M.offsetHeight-innerHeight,s=Math.max(1,t*le),i=Math.max(0,Math.min(1,-e.top/s)),o=scrollY>se;!Y&&!R&&o&&te<.94&&i>=.94&&(R=!0,window.scrollTo({top:ce(),behavior:"smooth"})),i<.65&&(R=!1),te=i,se=scrollY,M.style.setProperty("--door-progress",i.toFixed(3));const a=V.getBoundingClientRect(),r=Te.getBoundingClientRect(),n=Math.max(105,Math.min(innerHeight*.56,r.bottom-18)),g=Math.max(0,Math.min(1,(n-r.top)/Math.max(1,r.height)));V.style.setProperty("--journey-progress",g.toFixed(3));const m=i>.94&&a.top>innerHeight*.55,v=r.top<=innerHeight*.56&&r.bottom>=105,f=m||v;let x,C;m?(x=innerWidth*.78,C=innerHeight*.54):v?(x=r.left+r.width/2,C=n):(x=innerWidth*.5,C=innerHeight*.6),u.style.setProperty("--guide-screen-x",`${x}px`),u.style.setProperty("--guide-screen-y",`${C}px`),u.classList.toggle("is-following",f),u.classList.toggle("has-tip",m&&de),u.classList.toggle("is-tree-orbiting",m),u.classList.toggle("is-on-timeline",v),u.setAttribute("aria-hidden",String(!f)),qe.textContent="Click a flower to discover more about Queenie.",m&&Ce(),b.classList.toggle("guide-is-travelling",f),document.querySelector(".home-nav").classList.toggle("has-background",scrollY>8),W=0}window.addEventListener("scroll",()=>{W||(W=requestAnimationFrame(pe))},{passive:!0});pe();const L=[...document.querySelectorAll(".site-nav a")],E=document.querySelector(".nav-toggle"),me=document.querySelector(".site-nav");function ue(){E.setAttribute("aria-expanded","false"),E.setAttribute("aria-label","Open navigation menu"),me.classList.remove("is-open")}E.addEventListener("click",()=>{const e=E.getAttribute("aria-expanded")!=="true";E.setAttribute("aria-expanded",String(e)),E.setAttribute("aria-label",e?"Close navigation menu":"Open navigation menu"),me.classList.toggle("is-open",e)});L.forEach(e=>e.addEventListener("click",ue));L.map(e=>document.getElementById(e.dataset.section)).filter(Boolean);new IntersectionObserver(e=>{const t=e.filter(s=>s.isIntersecting).sort((s,i)=>i.intersectionRatio-s.intersectionRatio)[0];t&&L.forEach(s=>s.classList.toggle("is-active",s.dataset.section===t.target.id))},{rootMargin:"-34% 0px -52%",threshold:[0,.2,.5]}).observe(M);new IntersectionObserver(e=>{e[0].isIntersecting&&L.forEach(t=>t.classList.toggle("is-active",t.dataset.section==="journey"))},{rootMargin:"-32% 0px -55%",threshold:0}).observe(V);const Pe=document.querySelector(".work-section");new IntersectionObserver(e=>{e[0].isIntersecting&&L.forEach(t=>t.classList.toggle("is-active",t.dataset.section==="work"))},{rootMargin:"-32% 0px -55%",threshold:0}).observe(Pe);const Q=document.querySelector(".skills-section");new IntersectionObserver(e=>{e[0].isIntersecting&&L.forEach(t=>t.classList.toggle("is-active",t.dataset.section==="skills"))},{rootMargin:"-32% 0px -55%",threshold:0}).observe(Q);const De=document.querySelector(".contact-section");new IntersectionObserver(e=>{e[0].isIntersecting&&L.forEach(t=>t.classList.toggle("is-active",t.dataset.section==="contact"))},{rootMargin:"-32% 0px -55%",threshold:0}).observe(De);const Re=document.querySelectorAll(".journey-milestone"),Fe=new IntersectionObserver(e=>{e.forEach(t=>{t.isIntersecting&&t.target.classList.add("is-visible")})},{threshold:.2});Re.forEach(e=>Fe.observe(e));const T=document.querySelectorAll(".work-card"),Ne=new IntersectionObserver(e=>{e.forEach(t=>{t.isIntersecting&&t.target.classList.add("is-visible")})},{threshold:.15});T.forEach(e=>Ne.observe(e));const A=[...document.querySelectorAll(".work-filter")],ie=document.querySelector(".work-filter-indicator"),Oe=document.querySelector(".work-empty");let oe=0;function J(e){ie.style.setProperty("--filter-left",`${e.offsetLeft}px`),ie.style.setProperty("--filter-width",`${e.offsetWidth}px`)}async function Be(e){const t=++oe,s=[...T].filter(a=>e==="all"||a.dataset.category===e),i=A.find(a=>a.dataset.filter===e);A.forEach(a=>{const r=a===i;a.classList.toggle("is-active",r),a.setAttribute("aria-pressed",String(r))}),J(i);const o=[...T].filter(a=>!a.hidden);await Promise.all(o.map(a=>a.animate([{opacity:1,transform:"translateY(0)"},{opacity:0,transform:"translateY(12px)"}],{duration:180,easing:"ease-out",fill:"forwards"}).finished.catch(()=>{}))),t===oe&&(T.forEach(a=>{const r=s.includes(a);a.hidden=!r,a.classList.remove("is-filter-featured","is-filter-even")}),s.forEach((a,r)=>{a.querySelector(".project-number").textContent=e==="all"?z[Number(a.dataset.project)].number:String(r+1).padStart(2,"0")}),e!=="all"&&(s[0]?.classList.add("is-filter-featured"),s.slice(1).forEach((a,r)=>a.classList.toggle("is-filter-even",r%2===0))),Oe.hidden=s.length>0,s.forEach(a=>a.animate([{opacity:0,transform:"translateY(18px)"},{opacity:1,transform:"translateY(0)"}],{duration:380,delay:60,easing:"cubic-bezier(.2,.75,.2,1)",fill:"both"})))}A.forEach(e=>e.addEventListener("click",()=>Be(e.dataset.filter)));requestAnimationFrame(()=>J(A.find(e=>e.classList.contains("is-active"))));window.addEventListener("resize",()=>J(A.find(e=>e.classList.contains("is-active"))));const re=new WeakSet;function ge(e){if(!e||re.has(e))return;const t=[...e.querySelectorAll("img")];if(t.length<2)return;const s=e.closest(".project-preview, .case-study-visual")??e;let i=0,o=null;const a=g=>{const h=t[i];h.classList.add("is-leaving"),h.classList.remove("is-active"),window.setTimeout(()=>h.classList.remove("is-leaving"),600),i=g%t.length,t[i].classList.add("is-active")},r=()=>{o||(e.classList.add("is-playing"),o=window.setInterval(()=>a(i+1),1350))},n=()=>{window.clearInterval(o),o=null,e.classList.remove("is-playing"),a(0)};s.addEventListener("pointerenter",r),s.addEventListener("pointerleave",n),re.add(e)}document.querySelectorAll(".project-screenshot-carousel").forEach(ge);new IntersectionObserver(([e],t)=>{e.isIntersecting&&(Q.classList.add("is-visible"),t.disconnect())},{threshold:.18}).observe(Q);const D=document.querySelector(".letter-button"),Ge=document.querySelector(".letter-note");D.addEventListener("click",()=>{const e=D.getAttribute("aria-expanded")==="true";D.setAttribute("aria-expanded",String(!e)),Ge.hidden=e,D.querySelector("i").textContent=e?"＋":"−"});document.querySelector(".contact-form").addEventListener("submit",e=>{e.preventDefault();const t=new FormData(e.currentTarget),s=t.get("name").trim(),i=t.get("email").trim(),o=t.get("message").trim(),a=encodeURIComponent(`Portfolio enquiry from ${s}`),r=encodeURIComponent(`${o}

From: ${s}
Email: ${i}`);window.location.href=`mailto:qthamshinee@gmail.com?subject=${a}&body=${r}`});const l=document.querySelector(".project-modal"),he=l.querySelector(".project-modal-close"),q=l.querySelector(".project-video-viewer"),I=q.querySelector("video"),ye=q.querySelector(".project-video-close");let ve=null;function He(e,t){const s=z[e];ve=t,l.className=`project-modal project-modal--${s.slug}`,l.querySelector(".case-number").textContent=t.closest(".work-card")?.querySelector(".project-number")?.textContent??s.number,l.querySelector("#project-modal-title").textContent=s.title,l.querySelector(".case-role").textContent=s.role,l.querySelector(".case-summary").textContent=s.summary,l.querySelector(".case-challenge").textContent=s.challenge,l.querySelector(".case-approach").textContent=s.approach,l.querySelector(".case-outcome").textContent=s.outcome;const i=l.querySelector(".case-highlights");i.hidden=!s.highlights,i.innerHTML=s.highlights?.map(([m,v])=>`<span><strong>${m}</strong>${v}</span>`).join("")??"",l.querySelector(".case-tools").innerHTML=s.tools.map(m=>`<li>${m}</li>`).join("");const o=l.querySelector(".case-study-visual"),a=o.querySelector(".case-screenshot-carousel"),r=Array.isArray(s.images)&&s.images.length>0;a.hidden=!r,r&&a.dataset.project!==s.slug&&(a.dataset.project=s.slug,a.innerHTML=s.images.map((m,v)=>`<img class="${v===0?"is-active":""}" src="${d(m)}" alt="">`).join("")),o.classList.toggle("has-project-image",!!s.image||r),o.style.backgroundImage=s.image?`url("${d(s.image)}")`:"",r&&ge(a);const n=l.querySelector(".case-live-link");n.href=s.video?d(s.video):s.presentation?d(s.presentation):s.link,n.dataset.video=s.video?d(s.video):"",n.innerHTML=`${s.video?"View video":s.presentation?"Open interactive PPTX":s.slug==="language"||s.slug==="apcs"?"Watch project walkthrough":"View live project"} <span>↗</span>`;const g=l.querySelector(".case-prototype-link");g.hidden=!s.prototype,s.prototype&&(g.href=s.prototype);const h=l.querySelector(".case-manual-link");h.hidden=!s.manual,s.manual&&(h.href=d(s.manual)),l.hidden=!1,document.body.classList.add("modal-open"),requestAnimationFrame(()=>l.classList.add("is-open")),he.focus()}function fe(){I.pause(),I.removeAttribute("src"),I.load(),q.hidden=!0,l.classList.remove("is-video-open"),l.classList.remove("is-open"),document.body.classList.remove("modal-open"),setTimeout(()=>{l.hidden=!0,ve?.focus()},450)}l.querySelector(".case-live-link").addEventListener("click",e=>{const t=e.currentTarget.dataset.video;t&&(e.preventDefault(),I.src=t,q.hidden=!1,l.classList.add("is-video-open"),q.scrollIntoView({behavior:"smooth",block:"start"}),I.play().catch(()=>{}),ye.focus())});ye.addEventListener("click",()=>{I.pause(),q.hidden=!0,l.classList.remove("is-video-open"),l.querySelector(".case-live-link").focus()});T.forEach((e,t)=>{e.querySelectorAll(".project-preview,.case-study-link").forEach(s=>s.addEventListener("click",()=>He(t,s)))});he.addEventListener("click",fe);const K=[...document.querySelectorAll(".memory-flower")],Ue=document.querySelector(".discovery-progress span"),c=document.querySelector(".memory-modal"),X=document.querySelector(".memory-garden"),Ve=document.querySelector(".tree-instruction"),j=document.querySelector(".tree-guide-butterfly"),We=document.querySelector(".discovery-progress"),p={viewMode:"tree",currentMemory:null,activeFlowerIndex:0,discoveredMemories:new Set};let be=null,we=!1;const y=c.querySelector(".memory-photo-marquee");let w=null;y.addEventListener("pointerdown",e=>{y.classList.contains("is-single-photo")||(w={pointerId:e.pointerId,startX:e.clientX,startScroll:y.scrollLeft},y.classList.add("is-dragging"),y.setPointerCapture(e.pointerId))});y.addEventListener("pointermove",e=>{!w||w.pointerId!==e.pointerId||(y.scrollLeft=w.startScroll-(e.clientX-w.startX))});const Se=e=>{!w||w.pointerId!==e.pointerId||(w=null,y.classList.remove("is-dragging"))};y.addEventListener("pointerup",Se);y.addEventListener("pointercancel",Se);function F(){const e=p.discoveredMemories.size===k.length;if(K.forEach((t,s)=>{const i=p.discoveredMemories.has(s),o=!e&&s===p.activeFlowerIndex&&!i;t.className=`memory-flower ${i?"is-bloomed":o?"is-active":"is-closed"}`,t.setAttribute("aria-current",o?"step":"false"),t.setAttribute("aria-label",`${i?"Revisit":"Discover"} ${k[s].title} memory`)}),Ue.textContent=String(Math.min(p.discoveredMemories.size+(e?0:1),4)).padStart(2,"0"),We.classList.toggle("is-complete",e),Ve.textContent=e?"Four moments, one growing journey.":"Select the glowing flower to discover a memory.",j.classList.toggle("is-settled",e),!e&&we){const t=k[p.activeFlowerIndex].tree;j.style.setProperty("--guide-x",`${t.x}%`),j.style.setProperty("--guide-y",`${t.y}%`),j.classList.remove("is-guiding"),requestAnimationFrame(()=>j.classList.add("is-guiding"))}}new IntersectionObserver(([e],t)=>{e.isIntersecting&&(we=!0,document.querySelector(".door-sticky").classList.add("tree-is-revealing"),F(),t.disconnect())},{threshold:.55}).observe(document.querySelector(".door-sticky"));function ne(e,t,s=!1){const i=k[e];be=t,c.dataset.memory=i.id,p.currentMemory=e,p.viewMode="memory",s&&p.discoveredMemories.add(e),F(),c.querySelector("#modal-title").textContent=i.title,c.querySelector(".modal-copy .scene-label").textContent=`${i.chapter} · A personal chapter`,c.querySelector(".modal-description").textContent=i.description,c.querySelector(".modal-detail").textContent=i.detail;const o=c.querySelector(".modal-image");o.className=`modal-image memory-image-${i.art}`,o.style.backgroundImage=i.image?`url("${i.image}")`:"",o.setAttribute("aria-label",`${i.title} placeholder image`);const a=c.querySelector(".memory-photo-marquee"),r=c.querySelector(".detail-blossom"),n=Array.isArray(i.gallery)?i.gallery.filter(h=>h.image):[],g=n.length>0;if(a.hidden=!g,a.classList.remove("is-single-photo"),r.hidden=g,c.querySelector(".memory-detail").classList.toggle("has-photo-gallery",g),g){const h=3.4285714285714284,m=20/7;a.style.setProperty("--memory-scroll-duration",`${n.length*h}s`),a.style.setProperty("--memory-scroll-duration-mobile",`${n.length*m}s`);const v=[...n,...n];a.querySelector(".memory-photo-track").innerHTML=v.map((f,x)=>`
      ...
      </figure>`).join(""),a.scrollLeft=0}c.hidden=!1,document.body.classList.add("modal-open"),X.classList.add("is-softened"),requestAnimationFrame(()=>c.classList.add("is-open")),c.querySelector("#modal-title").focus()}K.forEach((e,t)=>{e.addEventListener("click",()=>{if(p.discoveredMemories.has(t)){ne(t,e);return}t===p.activeFlowerIndex&&(j.classList.remove("is-guiding"),ne(t,e,!0))})});function ke(){c.classList.remove("is-open"),X.classList.remove("is-softened"),X.classList.remove("is-transitioning"),document.body.classList.remove("modal-open"),p.viewMode="tree";const e=k.findIndex((t,s)=>!p.discoveredMemories.has(s));p.activeFlowerIndex=e===-1?0:e,F(),setTimeout(()=>{c.hidden=!0,K[p.currentMemory]?.classList.remove("is-entering"),be?.focus(),p.currentMemory=null},500)}c.addEventListener("click",ke);window.addEventListener("keydown",e=>{e.key==="Escape"&&ue(),e.key==="Escape"&&!c.hidden&&ke(),e.key==="Escape"&&!l.hidden&&fe()});matchMedia("(prefers-reduced-motion:reduce)").matches&&Me.classList.add("is-visible");F();
