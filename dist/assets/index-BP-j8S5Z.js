(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const n of o.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function s(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(i){if(i.ep)return;i.ep=!0;const o=s(i);fetch(i.href,o)}})();const S=[{id:"beginning",chapter:"01",title:"Where It All Began",detail:"Curiosity was where it all started",description:"I started my journey without knowing exactly where it would lead. Through university projects, new experiences, and plenty of learning along the way, I gradually discovered my interest in creating digital experiences that bring creativity and technology together. Looking back at where I started reminds me how much I’ve grown — and how much more there is to explore.",image:"",art:"beginning",gallery:[{label:"Then",caption:"Where it started",image:"./assets/flower1-then.jpg"},{label:"Now",caption:"Still learning, still growing.",image:"./assets/flower1-now.jpg"}],tree:{x:50,y:29},position:{x:50,y:12}},{id:"proud-moment",chapter:"02",title:"A Proud Moment",detail:"Performance · Dean’s List · A full-circle journey",description:"Since Semester 1, I have taken part as both a dancer and singer in MAJIS and ISSNITE. MAJIS is a celebratory gathering that recognises Dean’s List students, while ISSNITE is our faculty’s farewell celebration for final-semester students. I began by contributing as a performer, then attended my final MAJIS in Semester 5 to celebrate my Semester 4 Dean’s List achievement. Later, I returned to ISSNITE in a senior role—a full-circle moment that showed how much I had grown in confidence, experience and responsibility.",image:"",art:"internship",gallery:[{label:"The Beginning",caption:"Taking part as a dancer and singer",image:"./assets/flower2-performer.jpg"},{label:"A Milestone",caption:"My final MAJIS",image:"./assets/flower2-deans-list.jpg"},{label:"Full Circle",caption:"Returning to ISSNITE in a senior role",image:"./assets/flower2-senior.jpg"}],tree:{x:65,y:43},position:{x:88,y:48}},{id:"beyond-screen",chapter:"03",title:"Beyond the Screen",detail:"The people, places and small joys that keep me grounded",description:"Beyond studying, designing and building, I value the small experiences that help me recharge and stay grounded. I unwind at places such as Aquaria KLCC, enjoy music and concerts, and treasure time with my university friends. Taking on different part-time jobs—including working as a food-tasting promoter—has helped me become more independent, adaptable and confident when meeting people. Whether I am spending time close to nature, caring for my lovely hamster Mario, or photographing scenes that catch my eye, these moments reflect the person I am beyond the screen.",image:"",art:"hitern",gallery:[{label:"A Quiet Reset",caption:"Taking time to unwind at Aquaria KLCC",image:"./assets/flower3-aquaria.jpg"},{label:"Music & Memories",caption:"Experiencing IVE in concert",image:"./assets/flower3-concert.jpg"},{label:"My People",caption:"Making memories with my university friends",image:"./assets/flower3-friends.jpg"},{label:"Learning by Doing",caption:"Working as a food-tasting promoter",image:"./assets/flower3-part-time.jpg"},{label:"Close to Nature",caption:"Slowing down and enjoying the outdoors",image:"./assets/flower3-nature.jpg"},{label:"Little Companion",caption:"Spending time with my lovely hamster, Mario",image:"./assets/flower3-mario.jpg"},{label:"Through My Eyes",caption:"Capturing scenes that inspire me",image:"./assets/flower3-photography.jpg"}],tree:{x:51,y:58},position:{x:50,y:86}},{id:"what-drives-me",chapter:"04",title:"What Drives Me",detail:"Still learning. Still creating. Still growing.",description:"I’m drawn to the process of turning an idea into something people can actually see, use and enjoy. I love learning through experimentation, improving through feedback, and watching an idea gradually become a real experience.",image:"",art:"achievement",gallery:[{label:"What Drives Me",caption:"Turning ideas into experiences",image:"./assets/flower4.png"},{label:"Design in Progress",caption:"Bringing an idea to life in Figma",image:"./assets/flower4-design-process.jpeg"}],tree:{x:35,y:43},position:{x:12,y:50}}],ue="/",h=e=>`${ue}assets/${e}`;let ge=0;const x=(e="")=>{const t=`sakura-${ge++}`;return`
  ...
  <div class="sakura-cursor" aria-hidden="true">${he()}</div>
  <div class="scroll-butterfly-guide" aria-live="polite" aria-hidden="true">
    ...
    <img src="${h("guide-butterfly-open-cropped.png")}" alt="" />
  </div>
  ...
  <main class="home-page">
    ...
    <section id="hero" class="hero-scene">
      ...
      <div class="hero-nature" aria-hidden="true">
        <img class="hero-branch" src="${h("sakura-branch.png")}" alt="" />
      </div>
      ...
      <div class="hero-intro">
        ...
        <div class="journey-actions">
          ...
          <span class="button-butterfly" aria-hidden="true">
            <img class="butterfly-resting" src="${h("guide-butterfly-side-cropped.png")}" alt="" />
            <img class="butterfly-open" src="${h("guide-butterfly-open-cropped.png")}" alt="" />
          </span>
        </div>
      </div>
    </section>
      ...
      <div class="door-sticky">
        <section class="memory-garden" aria-labelledby="memory-heading">
          ...
          <div class="blossom-tree" aria-label="Interactive blossom memory tree">
            <img class="tree-art" src="${h("memory-tree-filled.png")}" alt="A full watercolor cherry blossom tree" />
            ${S.map((e,t)=>`
            ...
            <img class="tree-guide-butterfly" src="${h("guide-butterfly-open-cropped.png")}" alt="" aria-hidden="true" />
    ...
    <section id="journey" class="journey-section" aria-labelledby="journey-title">
      ...
      <div class="journey-layout">
        <div class="timeline-rail" aria-hidden="true">
          <i></i>
          <img class="timeline-butterfly" src="${h("guide-butterfly-open-cropped.png")}" alt="" />
        </div>
          ...
          <article class="work-card work-card--${e.slug} ${t===0?"work-card--featured":""}" data-project="${t}">
            <button class="project-preview" type="button" aria-label="View ${e.title} case study">
              ...
              ${e.images?`<span class="screenshot-carousel project-screenshot-carousel" aria-hidden="true">
                ${e.images.map((s,a)=>`<img class="${a===0?"is-active":""}" src="${h(s)}" alt="">`).join("")}
              </span>`:""}
      ...
      <div class="tools-showcase" aria-label="Tools and applications I use">
        ...
        <div class="tools-marquee">
          <div class="tools-track">
            ${[...A,...A].map((e,t)=>`
              <div class="tool-item" ${t>=A.length?'aria-hidden="true"':""}>
...
`;const P=[...document.querySelectorAll(".greeting-word")],ve=document.querySelector(".begin-cue");let q=0;window.setInterval(()=>{P[q].classList.remove("is-visible"),q=(q+1)%P.length,P[q].classList.add("is-visible")},1450);const X=document.querySelector(".sakura-cursor"),fe=matchMedia("(hover:hover) and (pointer:fine) and (min-width:1025px) and (prefers-reduced-motion:no-preference)").matches;let D=0,B={x:-80,y:-80},Q=0;const H=new Set;fe&&window.addEventListener("pointermove",e=>{if(B={x:e.clientX,y:e.clientY},D||(D=requestAnimationFrame(()=>{X.style.transform=`translate3d(${B.x}px,${B.y}px,0)`,X.classList.add("is-visible"),D=0})),performance.now()-Q<110||H.size>=12)return;Q=performance.now();const t=document.createElement("i");t.className="trail-petal",t.style.cssText=`left:${e.clientX}px;top:${e.clientY}px;--drift:${(Math.random()-.5)*60}px;--spin:${(Math.random()-.5)*240}deg`,H.add(t),document.body.append(t),t.addEventListener("animationend",()=>{H.delete(t),t.remove()},{once:!0})},{passive:!0});const b=document.querySelector(".hero-scene");document.querySelector(".primary-button");const m=document.querySelector(".scroll-butterfly-guide"),be=m.querySelector(".guide-tip");new IntersectionObserver(([e])=>{e.isIntersecting&&!b.classList.contains("has-grown")&&b.classList.add("has-grown")},{threshold:.28}).observe(b);const L=document.querySelector(".hero-nature"),F=new Set;let V=0;matchMedia("(hover:hover) and (pointer:fine) and (prefers-reduced-motion:no-preference)").matches&&(b.addEventListener("pointermove",e=>{const t=b.getBoundingClientRect(),s={x:t.left+t.width*.77,y:t.top+t.height*.34},a=e.clientX-s.x,i=e.clientY-s.y,o=Math.hypot(a,i);if(o>180){L.style.setProperty("--react-x","0deg"),L.style.setProperty("--react-y","0px");return}const n=1-o/180;if(L.style.setProperty("--react-x",`${Math.max(-3,Math.min(3,-a/55*n))}deg`),L.style.setProperty("--react-y",`${-i/20*n}px`),performance.now()-V>850&&F.size<3&&Math.random()>.55){V=performance.now();const r=document.createElement("i");r.className="released-petal",r.style.cssText=`left:${68+Math.random()*22}%;top:${24+Math.random()*28}%;--petal-drift:${(Math.random()-.5)*140}px;--petal-spin:${160+Math.random()*260}deg`,F.add(r),b.append(r),r.addEventListener("animationend",()=>{F.delete(r),r.remove()},{once:!0})}},{passive:!0}),b.addEventListener("pointerleave",()=>{L.style.setProperty("--react-x","0deg"),L.style.setProperty("--react-y","0px")}));const j=document.querySelector(".door-scene"),R=document.querySelector(".journey-section"),we=document.querySelector(".timeline-rail"),Se=document.querySelector('.site-nav a[data-section="door-scene"]'),ee=.68,N=matchMedia("(prefers-reduced-motion:reduce)").matches;let T=!1,_=0,J=scrollY;function te(){const e=Math.max(0,j.offsetHeight-innerHeight);return j.offsetTop+e*ee}Se.addEventListener("click",e=>{e.preventDefault();const t=te();T=!0,history.replaceState(null,"","#door-scene"),window.scrollTo({top:t,behavior:N?"auto":"smooth"})});let G=0,K=!1,se=!1;function ke(){if(K||N)return;const e=[...document.querySelectorAll(".memory-flower")].map(n=>{const r=n.getBoundingClientRect();return{x:r.left+r.width/2,y:r.top+r.height/2}});if(e.length!==S.length)return;K=!0;const t={x:innerWidth*.78,y:innerHeight*.62},s=[{x:-60,y:Math.max(innerHeight*.55,e[0].y+70)},...e,t],a=[0,.12,.32,.5,.68,.86],i=s.map((n,r)=>({offset:a[r],transform:`translate3d(${n.x}px,${n.y}px,0) translate(-50%,-50%) scale(${r?1:.72})`,opacity:r?1:0,easing:"cubic-bezier(.35,.05,.25,1)"})),o=m.animate(i,{duration:7200,fill:"forwards"});o.finished.then(()=>{se=!0,m.style.setProperty("--guide-screen-x","78vw"),m.style.setProperty("--guide-screen-y","62vh"),m.classList.add("has-tip"),o.cancel()}).catch(()=>{})}function ae(){const e=j.getBoundingClientRect(),t=j.offsetHeight-innerHeight,s=Math.max(1,t*ee),a=Math.max(0,Math.min(1,-e.top/s)),i=scrollY>J;!N&&!T&&i&&_<.94&&a>=.94&&(T=!0,window.scrollTo({top:te(),behavior:"smooth"})),a<.65&&(T=!1),_=a,J=scrollY,j.style.setProperty("--door-progress",a.toFixed(3));const o=R.getBoundingClientRect(),n=we.getBoundingClientRect(),r=Math.max(105,Math.min(innerHeight*.56,n.bottom-18)),u=Math.max(0,Math.min(1,(r-n.top)/Math.max(1,n.height)));R.style.setProperty("--journey-progress",u.toFixed(3));const p=a>.94&&o.top>innerHeight*.55,v=n.top<=innerHeight*.56&&n.bottom>=105,f=p||v;let k,I;p?(k=innerWidth*.78,I=innerHeight*.54):v?(k=n.left+n.width/2,I=r):(k=innerWidth*.5,I=innerHeight*.6),m.style.setProperty("--guide-screen-x",`${k}px`),m.style.setProperty("--guide-screen-y",`${I}px`),m.classList.toggle("is-following",f),m.classList.toggle("has-tip",p&&se),m.classList.toggle("is-tree-orbiting",p),m.classList.toggle("is-on-timeline",v),m.setAttribute("aria-hidden",String(!f)),be.textContent="Click a flower to discover more about Queenie.",p&&ke(),b.classList.toggle("guide-is-travelling",f),document.querySelector(".home-nav").classList.toggle("has-background",scrollY>8),G=0}window.addEventListener("scroll",()=>{G||(G=requestAnimationFrame(ae))},{passive:!0});ae();const M=[...document.querySelectorAll(".site-nav a")];M.map(e=>document.getElementById(e.dataset.section)).filter(Boolean);new IntersectionObserver(e=>{const t=e.filter(s=>s.isIntersecting).sort((s,a)=>a.intersectionRatio-s.intersectionRatio)[0];t&&M.forEach(s=>s.classList.toggle("is-active",s.dataset.section===t.target.id))},{rootMargin:"-34% 0px -52%",threshold:[0,.2,.5]}).observe(j);new IntersectionObserver(e=>{e[0].isIntersecting&&M.forEach(t=>t.classList.toggle("is-active",t.dataset.section==="journey"))},{rootMargin:"-32% 0px -55%",threshold:0}).observe(R);const xe=document.querySelector(".work-section");new IntersectionObserver(e=>{e[0].isIntersecting&&M.forEach(t=>t.classList.toggle("is-active",t.dataset.section==="work"))},{rootMargin:"-32% 0px -55%",threshold:0}).observe(xe);const U=document.querySelector(".skills-section");new IntersectionObserver(e=>{e[0].isIntersecting&&M.forEach(t=>t.classList.toggle("is-active",t.dataset.section==="skills"))},{rootMargin:"-32% 0px -55%",threshold:0}).observe(U);const Le=document.querySelector(".contact-section");new IntersectionObserver(e=>{e[0].isIntersecting&&M.forEach(t=>t.classList.toggle("is-active",t.dataset.section==="contact"))},{rootMargin:"-32% 0px -55%",threshold:0}).observe(Le);const $e=document.querySelectorAll(".journey-milestone"),je=new IntersectionObserver(e=>{e.forEach(t=>{t.isIntersecting&&t.target.classList.add("is-visible")})},{threshold:.2});$e.forEach(e=>je.observe(e));const ie=document.querySelectorAll(".work-card"),Me=new IntersectionObserver(e=>{e.forEach(t=>{t.isIntersecting&&t.target.classList.add("is-visible")})},{threshold:.15});ie.forEach(e=>Me.observe(e));const Y=new WeakSet;function oe(e){if(!e||Y.has(e))return;const t=[...e.querySelectorAll("img")];if(t.length<2)return;const s=e.closest(".project-preview, .case-study-visual")??e;let a=0,i=null;const o=u=>{const g=t[a];g.classList.add("is-leaving"),g.classList.remove("is-active"),window.setTimeout(()=>g.classList.remove("is-leaving"),600),a=u%t.length,t[a].classList.add("is-active")},n=()=>{i||(e.classList.add("is-playing"),i=window.setInterval(()=>o(a+1),1350))},r=()=>{window.clearInterval(i),i=null,e.classList.remove("is-playing"),o(0)};s.addEventListener("pointerenter",n),s.addEventListener("pointerleave",r),Y.add(e)}document.querySelectorAll(".project-screenshot-carousel").forEach(oe);new IntersectionObserver(([e],t)=>{e.isIntersecting&&(U.classList.add("is-visible"),t.disconnect())},{threshold:.18}).observe(U);const C=document.querySelector(".letter-button"),Ie=document.querySelector(".letter-note");C.addEventListener("click",()=>{const e=C.getAttribute("aria-expanded")==="true";C.setAttribute("aria-expanded",String(!e)),Ie.hidden=e,C.querySelector("i").textContent=e?"＋":"−"});document.querySelector(".contact-form").addEventListener("submit",e=>{e.preventDefault();const t=new FormData(e.currentTarget),s=t.get("name").trim(),a=t.get("email").trim(),i=t.get("message").trim(),o=encodeURIComponent(`Portfolio enquiry from ${s}`),n=encodeURIComponent(`${i}

From: ${s}
Email: ${a}`);window.location.href=`mailto:qthamshinee@gmail.com?subject=${o}&body=${n}`});const l=document.querySelector(".project-modal"),re=l.querySelector(".project-modal-close");let ne=null;function qe(e,t){const s=Z[e];ne=t,l.className=`project-modal project-modal--${s.slug}`,l.querySelector(".case-number").textContent=s.number,l.querySelector("#project-modal-title").textContent=s.title,l.querySelector(".case-role").textContent=s.role,l.querySelector(".case-summary").textContent=s.summary,l.querySelector(".case-challenge").textContent=s.challenge,l.querySelector(".case-approach").textContent=s.approach,l.querySelector(".case-outcome").textContent=s.outcome;const a=l.querySelector(".case-highlights");a.hidden=!s.highlights,a.innerHTML=s.highlights?.map(([p,v])=>`<span><strong>${p}</strong>${v}</span>`).join("")??"",l.querySelector(".case-tools").innerHTML=s.tools.map(p=>`<li>${p}</li>`).join("");const i=l.querySelector(".case-study-visual"),o=i.querySelector(".case-screenshot-carousel"),n=Array.isArray(s.images)&&s.images.length>0;o.hidden=!n,n&&o.dataset.project!==s.slug&&(o.dataset.project=s.slug,o.innerHTML=s.images.map((p,v)=>`<img class="${v===0?"is-active":""}" src="${h(p)}" alt="">`).join("")),i.classList.toggle("has-project-image",!!s.image||n),i.style.backgroundImage=s.image?`url("${h(s.image)}")`:"",n&&oe(o);const r=l.querySelector(".case-live-link");r.href=s.link,r.textContent=s.slug==="language"||s.slug==="event"?"Watch project walkthrough":"View live project";const u=l.querySelector(".case-prototype-link");u.hidden=!s.prototype,s.prototype&&(u.href=s.prototype);const g=l.querySelector(".case-manual-link");g.hidden=!s.manual,s.manual&&(g.href=h(s.manual)),l.hidden=!1,document.body.classList.add("modal-open"),requestAnimationFrame(()=>l.classList.add("is-open")),re.focus()}function le(){l.classList.remove("is-open"),document.body.classList.remove("modal-open"),setTimeout(()=>{l.hidden=!0,ne?.focus()},450)}ie.forEach((e,t)=>{e.querySelectorAll(".project-preview,.case-study-link").forEach(s=>s.addEventListener("click",()=>qe(t,s)))});re.addEventListener("click",le);const W=[...document.querySelectorAll(".memory-flower")],Ce=document.querySelector(".discovery-progress span"),c=document.querySelector(".memory-modal"),O=document.querySelector(".memory-garden"),Te=document.querySelector(".tree-instruction"),$=document.querySelector(".tree-guide-butterfly"),Ee=document.querySelector(".discovery-progress"),d={viewMode:"tree",currentMemory:null,activeFlowerIndex:0,discoveredMemories:new Set};let ce=null,de=!1;const y=c.querySelector(".memory-photo-marquee");let w=null;y.addEventListener("pointerdown",e=>{y.classList.contains("is-single-photo")||(w={pointerId:e.pointerId,startX:e.clientX,startScroll:y.scrollLeft},y.classList.add("is-dragging"),y.setPointerCapture(e.pointerId))});y.addEventListener("pointermove",e=>{!w||w.pointerId!==e.pointerId||(y.scrollLeft=w.startScroll-(e.clientX-w.startX))});const pe=e=>{!w||w.pointerId!==e.pointerId||(w=null,y.classList.remove("is-dragging"))};y.addEventListener("pointerup",pe);y.addEventListener("pointercancel",pe);function E(){const e=d.discoveredMemories.size===S.length;if(W.forEach((t,s)=>{const a=d.discoveredMemories.has(s),i=!e&&s===d.activeFlowerIndex&&!a;t.className=`memory-flower ${a?"is-bloomed":i?"is-active":"is-closed"}`,t.setAttribute("aria-current",i?"step":"false"),t.setAttribute("aria-label",`${a?"Revisit":"Discover"} ${S[s].title} memory`)}),Ce.textContent=String(Math.min(d.discoveredMemories.size+(e?0:1),4)).padStart(2,"0"),Ee.classList.toggle("is-complete",e),Te.textContent=e?"Four moments, one growing journey.":"Select the glowing flower to discover a memory.",$.classList.toggle("is-settled",e),!e&&de){const t=S[d.activeFlowerIndex].tree;$.style.setProperty("--guide-x",`${t.x}%`),$.style.setProperty("--guide-y",`${t.y}%`),$.classList.remove("is-guiding"),requestAnimationFrame(()=>$.classList.add("is-guiding"))}}new IntersectionObserver(([e],t)=>{e.isIntersecting&&(de=!0,document.querySelector(".door-sticky").classList.add("tree-is-revealing"),E(),t.disconnect())},{threshold:.55}).observe(document.querySelector(".door-sticky"));function z(e,t,s=!1){const a=S[e];ce=t,c.dataset.memory=a.id,d.currentMemory=e,d.viewMode="memory",s&&d.discoveredMemories.add(e),E(),c.querySelector("#modal-title").textContent=a.title,c.querySelector(".modal-copy .scene-label").textContent=`${a.chapter} · A personal chapter`,c.querySelector(".modal-description").textContent=a.description,c.querySelector(".modal-detail").textContent=a.detail;const i=c.querySelector(".modal-image");i.className=`modal-image memory-image-${a.art}`,i.style.backgroundImage=a.image?`url("${a.image}")`:"",i.setAttribute("aria-label",`${a.title} placeholder image`);const o=c.querySelector(".memory-photo-marquee"),n=c.querySelector(".detail-blossom"),r=Array.isArray(a.gallery)?a.gallery.filter(g=>g.image):[],u=r.length>0;if(o.hidden=!u,o.classList.remove("is-single-photo"),n.hidden=u,c.querySelector(".memory-detail").classList.toggle("has-photo-gallery",u),u){const g=3.4285714285714284,p=20/7;o.style.setProperty("--memory-scroll-duration",`${r.length*g}s`),o.style.setProperty("--memory-scroll-duration-mobile",`${r.length*p}s`);const v=[...r,...r];o.querySelector(".memory-photo-track").innerHTML=v.map((f,k)=>`
      <figure class="memory-photo-card" ${k>=r.length?'aria-hidden="true"':""}>
        <img src="${f.image}" alt="${f.label} — ${f.caption}">
        <figcaption><strong>${f.label}</strong><span>${f.caption}</span></figcaption>
      </figure>`).join(""),o.scrollLeft=0}c.hidden=!1,document.body.classList.add("modal-open"),O.classList.add("is-softened"),requestAnimationFrame(()=>c.classList.add("is-open")),c.querySelector("#modal-title").focus()}W.forEach((e,t)=>{e.addEventListener("click",()=>{if(d.discoveredMemories.has(t)){z(t,e);return}t===d.activeFlowerIndex&&($.classList.remove("is-guiding"),z(t,e,!0))})});function me(){c.classList.remove("is-open"),O.classList.remove("is-softened"),O.classList.remove("is-transitioning"),document.body.classList.remove("modal-open"),d.viewMode="tree";const e=S.findIndex((t,s)=>!d.discoveredMemories.has(s));d.activeFlowerIndex=e===-1?0:e,E(),setTimeout(()=>{c.hidden=!0,W[d.currentMemory]?.classList.remove("is-entering"),ce?.focus(),d.currentMemory=null},500)}c.addEventListener("click",me);window.addEventListener("keydown",e=>{e.key==="Escape"&&!c.hidden&&me(),e.key==="Escape"&&!l.hidden&&le()});matchMedia("(prefers-reduced-motion:reduce)").matches&&ve.classList.add("is-visible");E();
