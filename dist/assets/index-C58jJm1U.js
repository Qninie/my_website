          ...
          <div class="tools-track">
            ${[...F,...F].map((e,t)=>`
              <div class="tool-item" ${t>=F.length?'aria-hidden="true"':""}>
                <span class="tool-mark"><img src="${d(`tool-icons/${xe[e]}`)}" alt="" loading="lazy"></span>
                <strong>${e}</strong>
              </div>`).join("")}
          </div>
        </div>
