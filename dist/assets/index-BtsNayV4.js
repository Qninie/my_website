(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function s(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(o){if(o.ep)return;o.ep=!0;const i=s(o);fetch(o.href,i)}})();const k=[{id:"beginning",chapter:"01",title:"Where It All Began",detail:"Curiosity was where it all started",description:"I started my journey without knowing exactly where it would lead. Through university projects, new experiences, and plenty of learning along the way, I gradually discovered my interest in creating digital experiences that bring creativity and technology together. Looking back at where I started reminds me how much I’ve grown — and how much more there is to explore.",image:"",art:"beginning",gallery:[{label:"Then",caption:"Where it started",image:"./assets/flower1-then.jpg"},{label:"Now",caption:"Still learning, still growing.",image:"./assets/flower1-now.jpg"}],tree:{x:50,y:29},mobileTree:{x:50,y:18},position:{x:50,y:12}},{id:"proud-moment",chapter:"02",title:"A Proud Moment",detail:"Performance · Dean’s List · A full-circle journey",description:"Since Semester 1, I have taken part as both a dancer and singer in MAJIS and ISSNITE. MAJIS is a celebratory gathering that recognises Dean’s List students, while ISSNITE is our faculty’s farewell celebration for final-semester students. I began by contributing as a performer, then attended my final MAJIS in Semester 5 to celebrate my Semester 4 Dean’s List achievement. Later, I returned to ISSNITE in a senior role—a full-circle moment that showed how much I had grown in confidence, experience and responsibility.",image:"",art:"internship",gallery:[{label:"The Beginning",caption:"Taking part as a dancer and singer",image:"./assets/flower2-performer.jpg"},{label:"A Milestone",caption:"My final MAJIS",image:"./assets/flower2-deans-list.jpg"},{label:"Full Circle",caption:"Returning to ISSNITE in a senior role",image:"./assets/flower2-senior.jpg"}],tree:{x:65,y:43},mobileTree:{x:76,y:40},position:{x:88,y:48}},{id:"beyond-classroom",chapter:"03",title:"Beyond the Classroom",detail:"Some of the best lessons happened outside of it.",description:"Taking part in activities beyond academics gave me opportunities to connect with different people, work as part of a team, and step outside my comfort zone. Each experience taught me something new and became a meaningful part of my growth throughout my student journey.",image:"",art:"hitern",gallery:[{label:"Teamwork",caption:"Learning and contributing together",image:"./assets/flower3-classroom-2.jpg"},{label:"Communication",caption:"Connecting through shared activities",image:"./assets/flower3-classroom-3.jpg"},{label:"New Experiences",caption:"Stepping outside my comfort zone",image:"./assets/flower3-classroom-4.jpg"},{label:"Growth",caption:"Building confidence with others",image:"./assets/flower3-classroom-5.jpg"},{label:"Teamwork",caption:"Growing through every experience",image:"./assets/flower3-classroom-7.jpg"},{label:"New Experiences",caption:"Making memories beyond the classroom",image:"./assets/flower3-classroom-8.jpg"}],tree:{x:51,y:58},mobileTree:{x:50,y:63},position:{x:50,y:86}},{id:"what-drives-me",chapter:"04",title:"What Drives Me",detail:"Still learning. Still creating. Still growing.",description:"I’m drawn to the process of turning an idea into something people can actually see, use and enjoy. I love learning through experimentation, improving through feedback, and watching an idea gradually become a real experience.",image:"",art:"achievement",gallery:[{label:"What Drives Me",caption:"Turning ideas into experiences",image:"./assets/flower4.png"},{label:"Design in Progress",caption:"Bringing an idea to life in Figma",image:"./assets/flower4-design-process.jpeg"}],tree:{x:35,y:43},mobileTree:{x:24,y:40},position:{x:12,y:50}}],Le="/",p=e=>`${Le}assets/${e}`;let $e=0;const S=(e="")=>{const t=`sakura-${$e++}`;return`
  ...
  <div class="sakura-cursor" aria-hidden="true">${je()}</div>
          ...
          <article class="work-card work-card--${e.slug} ${t===0?"work-card--featured":""}" data-project="${t}" data-category="${e.category}">
            <button class="project-preview" type="button" aria-label="View ${e.title} case study">
              ...
              ${e.images?`<span class="screenshot-carousel project-screenshot-carousel" aria-hidden="true">
                ${e.images.map((s,a)=>`<img class="${a===0?"is-active":""}" src="${p(s)}" alt="">`).join("")}
              </span>`:""}
      ...
      <div class="tools-showcase" aria-label="Tools and applications I use">
        ...
        <div class="tools-marquee">
          <div class="tools-track">
            ${[...N,...N].map((e,t)=>`
              <div class="tool-item" ${t>=N.length?'aria-hidden="true"':""}>
...
`;const O=[...document.querySelectorAll(".greeting-word")],Ie=document.querySelector(".begin-cue");let P=0;window.setInterval(()=>{O[P].classList.remove("is-visible"),P=(P+1)%O.length,O[P].classList.add("is-visible")},1450);const Z=document.querySelector(".sakura-cursor"),Te=matchMedia("(hover:hover) and (pointer:fine) and (min-width:1025px) and (prefers-reduced-motion:no-preference)").matches;let B=0,G={x:-80,y:-80},ee=0;const H=new Set;Te&&window.addEventListener("pointermove",e=>{if(G={x:e.clientX,y:e.clientY},B||(B=requestAnimationFrame(()=>{Z.style.transform=`translate3d(${G.x}px,${G.y}px,0)`,Z.classList.add("is-visible"),B=0})),performance.now()-ee<110||H.size>=12)return;ee=performance.now();const t=document.createElement("i");t.className="trail-petal",t.style.cssText=`left:${e.clientX}px;top:${e.clientY}px;--drift:${(Math.random()-.5)*60}px;--spin:${(Math.random()-.5)*240}deg`,H.add(t),document.body.append(t),t.addEventListener("animationend",()=>{H.delete(t),t.remove()},{once:!0})},{passive:!0});const b=document.querySelector(".hero-scene");document.querySelector(".primary-button");const g=document.querySelector(".scroll-butterfly-guide"),qe=g.querySelector(".guide-tip");new IntersectionObserver(([e])=>{e.isIntersecting&&!b.classList.contains("has-grown")&&b.classList.add("has-grown")},{threshold:.28}).observe(b);const $=document.querySelector(".hero-nature"),U=new Set;let te=0;matchMedia("(hover:hover) and (pointer:fine) and (prefers-reduced-motion:no-preference)").matches&&(b.addEventListener("pointermove",e=>{const t=b.getBoundingClientRect(),s={x:t.left+t.width*.77,y:t.top+t.height*.34},a=e.clientX-s.x,o=e.clientY-s.y,i=Math.hypot(a,o);if(i>180){$.style.setProperty("--react-x","0deg"),$.style.setProperty("--react-y","0px");return}const r=1-i/180;if($.style.setProperty("--react-x",`${Math.max(-3,Math.min(3,-a/55*r))}deg`),$.style.setProperty("--react-y",`${-o/20*r}px`),performance.now()-te>850&&U.size<3&&Math.random()>.55){te=performance.now();const n=document.createElement("i");n.className="released-petal",n.style.cssText=`left:${68+Math.random()*22}%;top:${24+Math.random()*28}%;--petal-drift:${(Math.random()-.5)*140}px;--petal-spin:${160+Math.random()*260}deg`,U.add(n),b.append(n),n.addEventListener("animationend",()=>{U.delete(n),n.remove()},{once:!0})}},{passive:!0}),b.addEventListener("pointerleave",()=>{$.style.setProperty("--react-x","0deg"),$.style.setProperty("--react-y","0px")}));const E=document.querySelector(".door-scene"),V=document.querySelector(".journey-section"),Ae=document.querySelector(".timeline-rail"),Ce=document.querySelector('.site-nav a[data-section="door-scene"]'),ce=.68,Y=matchMedia("(prefers-reduced-motion:reduce)").matches;let R=!1,se=0,ie=scrollY;function de(){const e=Math.max(0,E.offsetHeight-innerHeight);return E.offsetTop+e*ce}Ce.addEventListener("click",e=>{e.preventDefault();const t=de();R=!0,history.replaceState(null,"","#door-scene"),window.scrollTo({top:t,behavior:Y?"auto":"smooth"})});let W=0,ae=!1,pe=!1;function Pe(){if(ae||Y)return;const e=[...document.querySelectorAll(".memory-flower")].map(n=>{const c=n.getBoundingClientRect();return{x:c.left+c.width/2,y:c.top+c.height/2}});if(e.length!==k.length)return;ae=!0;const t=matchMedia("(max-width:720px)").matches,s=t?{x:innerWidth*.5,y:innerHeight*.34}:{x:innerWidth*.78,y:innerHeight*.62},a=[{x:-60,y:Math.max(innerHeight*.55,e[0].y+70)},...e,s],o=[0,.12,.32,.5,.68,.86],i=a.map((n,c)=>({offset:o[c],transform:`translate3d(${n.x}px,${n.y}px,0) translate(-50%,-50%) scale(${c?1:.72})`,opacity:c?1:0,easing:"cubic-bezier(.35,.05,.25,1)"})),r=g.animate(i,{duration:7200,fill:"forwards"});r.finished.then(()=>{pe=!0,g.style.setProperty("--guide-screen-x",t?"50vw":"78vw"),g.style.setProperty("--guide-screen-y",t?"34vh":"62vh"),g.classList.add("has-tip"),r.cancel()}).catch(()=>{})}function me(){const e=E.getBoundingClientRect(),t=E.offsetHeight-innerHeight,s=Math.max(1,t*ce),a=Math.max(0,Math.min(1,-e.top/s)),o=scrollY>ie;!Y&&!R&&o&&se<.94&&a>=.94&&(R=!0,window.scrollTo({top:de(),behavior:"smooth"})),a<.65&&(R=!1),se=a,ie=scrollY,E.style.setProperty("--door-progress",a.toFixed(3));const i=V.getBoundingClientRect(),r=Ae.getBoundingClientRect(),n=Math.max(105,Math.min(innerHeight*.56,r.bottom-18)),c=Math.max(0,Math.min(1,(n-r.top)/Math.max(1,r.height)));V.style.setProperty("--journey-progress",c.toFixed(3));const u=a>.94&&i.top>innerHeight*.55,v=r.top<=innerHeight*.56&&r.bottom>=105,f=u||v;let L,C;if(u){const _=matchMedia("(max-width:720px)").matches;L=innerWidth*(_?.5:.78),C=innerHeight*(_?.34:.54)}else v?(L=r.left+r.width/2,C=n):(L=innerWidth*.5,C=innerHeight*.6);g.style.setProperty("--guide-screen-x",`${L}px`),g.style.setProperty("--guide-screen-y",`${C}px`),g.classList.toggle("is-following",f),g.classList.toggle("has-tip",u&&pe),g.classList.toggle("is-tree-orbiting",u),g.classList.toggle("is-on-timeline",v),g.setAttribute("aria-hidden",String(!f)),qe.textContent="Click a flower to discover more about Queenie.",u&&Pe(),b.classList.toggle("guide-is-travelling",f),document.querySelector(".home-nav").classList.toggle("has-background",scrollY>8),W=0}window.addEventListener("scroll",()=>{W||(W=requestAnimationFrame(me))},{passive:!0});me();const x=[...document.querySelectorAll(".site-nav a")],M=document.querySelector(".nav-toggle"),ue=document.querySelector(".site-nav");function ge(){M.setAttribute("aria-expanded","false"),M.setAttribute("aria-label","Open navigation menu"),ue.classList.remove("is-open")}M.addEventListener("click",()=>{const e=M.getAttribute("aria-expanded")!=="true";M.setAttribute("aria-expanded",String(e)),M.setAttribute("aria-label",e?"Close navigation menu":"Open navigation menu"),ue.classList.toggle("is-open",e)});x.forEach(e=>e.addEventListener("click",ge));x.map(e=>document.getElementById(e.dataset.section)).filter(Boolean);new IntersectionObserver(e=>{const t=e.filter(s=>s.isIntersecting).sort((s,a)=>a.intersectionRatio-s.intersectionRatio)[0];t&&x.forEach(s=>s.classList.toggle("is-active",s.dataset.section===t.target.id))},{rootMargin:"-34% 0px -52%",threshold:[0,.2,.5]}).observe(E);new IntersectionObserver(e=>{e[0].isIntersecting&&x.forEach(t=>t.classList.toggle("is-active",t.dataset.section==="journey"))},{rootMargin:"-32% 0px -55%",threshold:0}).observe(V);const De=document.querySelector(".work-section");new IntersectionObserver(e=>{e[0].isIntersecting&&x.forEach(t=>t.classList.toggle("is-active",t.dataset.section==="work"))},{rootMargin:"-32% 0px -55%",threshold:0}).observe(De);const Q=document.querySelector(".skills-section");new IntersectionObserver(e=>{e[0].isIntersecting&&x.forEach(t=>t.classList.toggle("is-active",t.dataset.section==="skills"))},{rootMargin:"-32% 0px -55%",threshold:0}).observe(Q);const Re=document.querySelector(".contact-section");new IntersectionObserver(e=>{e[0].isIntersecting&&x.forEach(t=>t.classList.toggle("is-active",t.dataset.section==="contact"))},{rootMargin:"-32% 0px -55%",threshold:0}).observe(Re);const Fe=document.querySelectorAll(".journey-milestone"),Ne=new IntersectionObserver(e=>{e.forEach(t=>{t.isIntersecting&&t.target.classList.add("is-visible")})},{threshold:.2});Fe.forEach(e=>Ne.observe(e));const q=document.querySelectorAll(".work-card"),Oe=new IntersectionObserver(e=>{e.forEach(t=>{t.isIntersecting&&t.target.classList.add("is-visible")})},{threshold:.15});q.forEach(e=>Oe.observe(e));const A=[...document.querySelectorAll(".work-filter")],oe=document.querySelector(".work-filter-indicator"),Be=document.querySelector(".work-empty");let re=0;function J(e){oe.style.setProperty("--filter-left",`${e.offsetLeft}px`),oe.style.setProperty("--filter-width",`${e.offsetWidth}px`)}async function Ge(e){const t=++re,s=[...q].filter(i=>e==="all"||i.dataset.category===e),a=A.find(i=>i.dataset.filter===e);A.forEach(i=>{const r=i===a;i.classList.toggle("is-active",r),i.setAttribute("aria-pressed",String(r))}),J(a);const o=[...q].filter(i=>!i.hidden);await Promise.all(o.map(i=>i.animate([{opacity:1,transform:"translateY(0)"},{opacity:0,transform:"translateY(12px)"}],{duration:180,easing:"ease-out",fill:"forwards"}).finished.catch(()=>{}))),t===re&&(q.forEach(i=>{const r=s.includes(i);i.hidden=!r,i.classList.remove("is-filter-featured","is-filter-even")}),s.forEach((i,r)=>{i.querySelector(".project-number").textContent=e==="all"?z[Number(i.dataset.project)].number:String(r+1).padStart(2,"0")}),e!=="all"&&(s[0]?.classList.add("is-filter-featured"),s.slice(1).forEach((i,r)=>i.classList.toggle("is-filter-even",r%2===0))),Be.hidden=s.length>0,s.forEach(i=>i.animate([{opacity:0,transform:"translateY(18px)"},{opacity:1,transform:"translateY(0)"}],{duration:380,delay:60,easing:"cubic-bezier(.2,.75,.2,1)",fill:"both"})))}A.forEach(e=>e.addEventListener("click",()=>Ge(e.dataset.filter)));requestAnimationFrame(()=>J(A.find(e=>e.classList.contains("is-active"))));window.addEventListener("resize",()=>J(A.find(e=>e.classList.contains("is-active"))));const ne=new WeakSet;function he(e){if(!e||ne.has(e))return;const t=[...e.querySelectorAll("img")];if(t.length<2)return;const s=e.closest(".project-preview, .case-study-visual")??e;let a=0,o=null;const i=c=>{const h=t[a];h.classList.add("is-leaving"),h.classList.remove("is-active"),window.setTimeout(()=>h.classList.remove("is-leaving"),600),a=c%t.length,t[a].classList.add("is-active")},r=()=>{o||(e.classList.add("is-playing"),o=window.setInterval(()=>i(a+1),1350))},n=()=>{window.clearInterval(o),o=null,e.classList.remove("is-playing"),i(0)};s.addEventListener("pointerenter",r),s.addEventListener("pointerleave",n),ne.add(e)}document.querySelectorAll(".project-screenshot-carousel").forEach(he);new IntersectionObserver(([e],t)=>{e.isIntersecting&&(Q.classList.add("is-visible"),t.disconnect())},{threshold:.18}).observe(Q);const D=document.querySelector(".letter-button"),He=document.querySelector(".letter-note");D.addEventListener("click",()=>{const e=D.getAttribute("aria-expanded")==="true";D.setAttribute("aria-expanded",String(!e)),He.hidden=e,D.querySelector("i").textContent=e?"＋":"−"});document.querySelector(".contact-form").addEventListener("submit",e=>{e.preventDefault();const t=new FormData(e.currentTarget),s=t.get("name").trim(),a=t.get("email").trim(),o=t.get("message").trim(),i=encodeURIComponent(`Portfolio enquiry from ${s}`),r=encodeURIComponent(`${o}

From: ${s}
Email: ${a}`);window.location.href=`mailto:qthamshinee@gmail.com?subject=${i}&body=${r}`});const l=document.querySelector(".project-modal"),ye=l.querySelector(".project-modal-close"),T=l.querySelector(".project-video-viewer"),I=T.querySelector("video"),ve=T.querySelector(".project-video-close");let fe=null;function Ue(e,t){const s=z[e];fe=t,l.className=`project-modal project-modal--${s.slug}`,l.querySelector(".case-number").textContent=t.closest(".work-card")?.querySelector(".project-number")?.textContent??s.number,l.querySelector("#project-modal-title").textContent=s.title,l.querySelector(".case-role").textContent=s.role,l.querySelector(".case-summary").textContent=s.summary,l.querySelector(".case-challenge").textContent=s.challenge,l.querySelector(".case-approach").textContent=s.approach,l.querySelector(".case-outcome").textContent=s.outcome;const a=l.querySelector(".case-highlights");a.hidden=!s.highlights,a.innerHTML=s.highlights?.map(([u,v])=>`<span><strong>${u}</strong>${v}</span>`).join("")??"",l.querySelector(".case-tools").innerHTML=s.tools.map(u=>`<li>${u}</li>`).join("");const o=l.querySelector(".case-study-visual"),i=o.querySelector(".case-screenshot-carousel"),r=Array.isArray(s.images)&&s.images.length>0;i.hidden=!r,r&&i.dataset.project!==s.slug&&(i.dataset.project=s.slug,i.innerHTML=s.images.map((u,v)=>`<img class="${v===0?"is-active":""}" src="${p(u)}" alt="">`).join("")),o.classList.toggle("has-project-image",!!s.image||r),o.style.backgroundImage=s.image?`url("${p(s.image)}")`:"",r&&he(i);const n=l.querySelector(".case-live-link");n.href=s.video?p(s.video):s.presentation?p(s.presentation):s.link,n.dataset.video=s.video?p(s.video):"",n.innerHTML=`${s.video?"View video":s.presentation?"Open interactive PPTX":s.slug==="language"||s.slug==="apcs"?"Watch project walkthrough":"View live project"} <span>↗</span>`;const c=l.querySelector(".case-prototype-link");c.hidden=!s.prototype,s.prototype&&(c.href=s.prototype);const h=l.querySelector(".case-manual-link");h.hidden=!s.manual,s.manual&&(h.href=p(s.manual)),l.hidden=!1,document.body.classList.add("modal-open"),requestAnimationFrame(()=>l.classList.add("is-open")),ye.focus()}function be(){I.pause(),I.removeAttribute("src"),I.load(),T.hidden=!0,l.classList.remove("is-video-open"),l.classList.remove("is-open"),document.body.classList.remove("modal-open"),setTimeout(()=>{l.hidden=!0,fe?.focus()},450)}l.querySelector(".case-live-link").addEventListener("click",e=>{const t=e.currentTarget.dataset.video;t&&(e.preventDefault(),I.src=t,T.hidden=!1,l.classList.add("is-video-open"),T.scrollIntoView({behavior:"smooth",block:"start"}),I.play().catch(()=>{}),ve.focus())});ve.addEventListener("click",()=>{I.pause(),T.hidden=!0,l.classList.remove("is-video-open"),l.querySelector(".case-live-link").focus()});q.forEach((e,t)=>{e.querySelectorAll(".project-preview,.case-study-link").forEach(s=>s.addEventListener("click",()=>Ue(t,s)))});ye.addEventListener("click",be);const K=[...document.querySelectorAll(".memory-flower")],Ve=document.querySelector(".discovery-progress span"),d=document.querySelector(".memory-modal"),X=document.querySelector(".memory-garden"),We=document.querySelector(".tree-instruction"),j=document.querySelector(".tree-guide-butterfly"),Qe=document.querySelector(".discovery-progress"),m={viewMode:"tree",currentMemory:null,activeFlowerIndex:0,discoveredMemories:new Set};let we=null,Se=!1;const y=d.querySelector(".memory-photo-marquee");let w=null;y.addEventListener("pointerdown",e=>{y.classList.contains("is-single-photo")||(w={pointerId:e.pointerId,startX:e.clientX,startScroll:y.scrollLeft},y.classList.add("is-dragging"),y.setPointerCapture(e.pointerId))});y.addEventListener("pointermove",e=>{!w||w.pointerId!==e.pointerId||(y.scrollLeft=w.startScroll-(e.clientX-w.startX))});const ke=e=>{!w||w.pointerId!==e.pointerId||(w=null,y.classList.remove("is-dragging"))};y.addEventListener("pointerup",ke);y.addEventListener("pointercancel",ke);function F(){const e=m.discoveredMemories.size===k.length;if(K.forEach((t,s)=>{const a=m.discoveredMemories.has(s),o=!e&&s===m.activeFlowerIndex&&!a;t.className=`memory-flower ${a?"is-bloomed":o?"is-active":"is-closed"}`,t.setAttribute("aria-current",o?"step":"false"),t.setAttribute("aria-label",`${a?"Revisit":"Discover"} ${k[s].title} memory`)}),Ve.textContent=String(Math.min(m.discoveredMemories.size+(e?0:1),4)).padStart(2,"0"),Qe.classList.toggle("is-complete",e),We.textContent=e?"Four moments, one growing journey.":"Select the glowing flower to discover a memory.",j.classList.toggle("is-settled",e),!e&&Se){const t=k[m.activeFlowerIndex].tree;j.style.setProperty("--guide-x",`${t.x}%`),j.style.setProperty("--guide-y",`${t.y}%`),j.classList.remove("is-guiding"),requestAnimationFrame(()=>j.classList.add("is-guiding"))}}new IntersectionObserver(([e],t)=>{e.isIntersecting&&(Se=!0,document.querySelector(".door-sticky").classList.add("tree-is-revealing"),F(),t.disconnect())},{threshold:.55}).observe(document.querySelector(".door-sticky"));function le(e,t,s=!1){const a=k[e];we=t,d.dataset.memory=a.id,m.currentMemory=e,m.viewMode="memory",s&&m.discoveredMemories.add(e),F(),d.querySelector("#modal-title").textContent=a.title,d.querySelector(".modal-copy .scene-label").textContent=`${a.chapter} · A personal chapter`,d.querySelector(".modal-description").textContent=a.description,d.querySelector(".modal-detail").textContent=a.detail;const o=d.querySelector(".modal-image");o.className=`modal-image memory-image-${a.art}`,o.style.backgroundImage=a.image?`url("${a.image}")`:"",o.setAttribute("aria-label",`${a.title} placeholder image`);const i=d.querySelector(".memory-photo-marquee"),r=d.querySelector(".detail-blossom"),n=Array.isArray(a.gallery)?a.gallery.filter(h=>h.image):[],c=n.length>0;if(i.hidden=!c,i.classList.remove("is-single-photo"),r.hidden=c,d.querySelector(".memory-detail").classList.toggle("has-photo-gallery",c),c){const h=3.4285714285714284,u=20/7;i.style.setProperty("--memory-scroll-duration",`${n.length*h}s`),i.style.setProperty("--memory-scroll-duration-mobile",`${n.length*u}s`);const v=[...n,...n];i.querySelector(".memory-photo-track").innerHTML=v.map((f,L)=>`
